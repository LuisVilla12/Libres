...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-03-2021 a las 12:19:06
...
(3, '2021-02-10', 'Febrero', 1, 'Pendiente', '0000-00-00', 'Inicio de operaciones.', 8),
(6, '2021-03-01', 'Marzo', 1, 'Pendiente', '0000-00-00', 'Inicio de operaciones del mes.', 8),
(8, '2021-03-04', 'Enero', 1, 'Pendiente', '0000-00-00', 'Inicio de operaciones del Mes.', 9),
...
--
ALTER TABLE `ejercicio_fiscal`
  MODIFY `idEjercicio_Fiscal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `reg_cuentas`
  MODIFY `idReg_Cuentas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;
